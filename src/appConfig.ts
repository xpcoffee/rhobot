 ...
 *
 * We've consciously made the decision to make this a flat structure to favour keeping this user-facing interface as
 *  clean as possible.
...
export interface AppConfig {
  ...
  /**
   * The AWS region in which DynamoDB table lives that's used to store Rhobot data
   * (currently only used in event command).
   */
